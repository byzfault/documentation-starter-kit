...
**If it's completely new** (medical devices, aerospace, etc.): Probably yes, but expect 2-4 weeks ramp-up while I build domain context.
...
**Listed as:** Zürich, Zurich, CH (personal connection)
