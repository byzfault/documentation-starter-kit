...
- I've led documentation for Mastercard's MDES Manager — the global card tokenisation platform enabling Apple Pay, Google Pay, and digital wallets — working in DITA XML across 379 pages, 100+ product screens, and 14 AI-optimised delivery guides
...
**If it's in my wheelhouse** (payments infrastructure, fintech, ZK cryptography, Web3, SaaS, APIs, developer tools): Yes, immediately effective.
...
**For contracts:** Day rate: £600+/day for contract work. Rate is consistent for senior fintech, payments, and crypto infrastructure engagements. Open to discussion on long-term or complex scopes.
