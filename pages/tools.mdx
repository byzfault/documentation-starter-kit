...
- **DITA XML** — Structured authoring for large-scale enterprise documentation (used at Mastercard)
- **DITA-OT** — DITA Open Toolkit for PDF generation and output processing
- **Claude Code CLI** — AI-assisted documentation and content engineering
...
> **Note:** Blockchain documentation remains a core capability, now alongside payments infrastructure and fintech as primary specialisms.
