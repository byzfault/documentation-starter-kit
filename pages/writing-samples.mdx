...
<Cards>
  <Card
    ...
    description="Complex smart contract pattern with Cairo code examples"
  />
  <Card
    title="Account Abstraction"
    href="https://docs.starknet.io/architecture-and-concepts/accounts/account-abstraction/"
    description="Conceptual documentation explaining StarkNet's account model"
  />
  <Card
...
<Cards>
  <Card
    ...
    href="https://docs.klevu.com"
    description="Frontend SDK documentation and integration guides"
  />
  <Card
    title="API Reference"
    href="https://docs.klevu.com"
    description="REST API documentation for search and recommendations"
  />
</Cards>
